...
<script>
    function confirmReservation(form) {
        ...
        message.innerText = "Veuillez entrer la durée de réservation en jours :";
        ...
        confirmBtn.style.background = "#f5b700";
        ...
        confirmBtn.onclick = function () {
            if (input.value.trim() !== "") {
                form.querySelector('input[name="reservationDuration"]').value = input.value;
